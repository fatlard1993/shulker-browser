package justfatlard.shulker_browser.gametest;
...
public final class SmokeTest implements FabricClientGameTest {
	...
	public void runTest(ClientGameTestContext context) {
		if (!FabricLoader.getInstance().isModLoaded("shulker-browser-justfatlard")) {
			throw new AssertionError("shulker-browser-justfatlard is not loaded: the test is testing nothing");
		}
